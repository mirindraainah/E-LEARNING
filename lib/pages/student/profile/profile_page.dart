  ...
  Widget _buildQrCode(User? user) {
    ...
    return FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
      ...
      builder: (context, snapshot) {
        ...
        String matricule = userData['matricule'] as String? ?? 'Non renseigné';
        List<String> parcoursListe = (userData['parcours'] as List<dynamic>?)
                ?.map((e) => e.toString())
                .toList() ??
            [];
        String parcours = parcoursListe.join(', ');
