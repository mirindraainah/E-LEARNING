...
class _HomePageState extends State<HomePage> {
  ...
  Color _getColorBasedOnAge(Timestamp timestamp) {
    ...
    // si l'annonce est moins de 23 heures
  ...
  void showEditDialog(String announcementId, String currentContent) {
    _editAnnouncementController.text = currentContent;
  ...
  String getTimeAgo(Timestamp? timestamp) {
    if (timestamp == null) {
      return 'Inconnu'; // texte par défaut
    }
    DateTime dateTime = timestamp.toDate();
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (_removedAnnouncements.contains(announcement.id)) {
                      return SizedBox.shrink(); // rien afficher
                    }
                    return Dismissible(
